...
class Client {
    ...
    async getAddressInfo(address) {
        return await (0, functions_1.getAddressInfo)(this.network, address);
    }
    async getAssetBalances(assetid) {
        return await (0, functions_1.getAssetBalances)(this.network, assetid);
    }
    async getAddressBalances(address, assetid) {
        return await (0, functions_1.getAddressBalances)(this.network, address, assetid);
    }
}
